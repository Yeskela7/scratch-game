...
public class WinCombination {
    ...
    private List<List<String>> coveredArea; // "%d:%d"
    @JsonProperty("when")
    private String when; //fixed enum same_symbols , linear_symbols
    ...
    public void setCoveredArea(List<List<String>> coveredArea) {
